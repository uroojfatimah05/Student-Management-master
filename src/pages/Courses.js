...
export default function Courses() {
  ...
  const createDocument = async (studentData) => {
    try {
      await setDoc(doc(firestore, 'Courses', studentData.id), studentData);
  ...
  const handleUpdate = async () => {
    ...
    try {
      await setDoc(doc(firestore, 'Courses', selectedStudent.id), updatedStudent);
                          ...
                          <td>
                            <Space>
                              <Tooltip name="Delete" color="red">
                                <Button danger icon={<DeleteOutlined />}onClick={() => {handleDelete(student);}}/>
                              </Tooltip>
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} lg={12}>
                <Form.Item label="Courses">
                  <Input placeholder="Input your Course"name="courses"value={state.courses}onChange={handleChange}/>
                </Form.Item>
              </Col>
              <Col span={24}>
